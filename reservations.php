...
while($row3 = mysqli_fetch_array($max_result, MYSQLI_ASSOC)){
...
if ($_SERVER['REQUEST_METHOD']=='POST') {
    ...
    if ($partysize > $max) {
        echo "Party must be smaller than $max";
    } else {
        ...
        while ($row = mysqli_fetch_array($result5, MYSQLI_ASSOC)) {
                ...
                // if greater than 40
                    ...
                    if ($left > 0){
                        ...
                        echo "Sorry, there are <strong>0</strong> reservations left out of <strong>$max</strong> available for this day.";    
                        }
                    }
